...
!function(){"use strict";function t(){var t={};return{on:function(e,n){return e.split(" ").forEach(function(e){t[e]||(t[e]=[]),t[e].push(n)}),this},trigger:function(e,n){return angular.forEach(t[e],function(t){t.call(null,n)}),this}}}function e(t,e){return t=t||[],t.length>0&&!angular.isObject(t[0])&&t.forEach(function(n,a){t[a]={},t[a][e]=n}),t}function n(t,e,n){for(var a=null,o=0;o<t.length;o++)if(i(t[o][n]).toLowerCase()===i(e[n]).toLowerCase()){a=t[o];break}return a}function a(t,e,n){if(!e)return t;var a=e.replace(/([.?*+^$[\]\\(){}|-])/g,"\\$1");return t.replace(new RegExp(a,"gi"),n)}function i(t){return angular.isUndefined(t)||null==t?"":t.toString().trim()}function o(t){return t.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}var r={backspace:8,tab:9,enter:13,escape:27,space:32,up:38,down:40,comma:188},s=9007199254740991,u=["text","email","url"],l=angular.module("ngTagsInput",[]);l.directive("tagsInput",["$timeout","$document","tagsInputConfig",function(a,o,l){function c(t,e){var a,o,r,s={};return a=function(e){return i(e[t.displayProperty])},o=function(e,n){e[t.displayProperty]=n},r=function(e){var i=a(e);return i&&i.length>=t.minLength&&i.length<=t.maxLength&&t.allowedTagsPattern.test(i)&&!n(s.items,e,t.displayProperty)},s.items=[],s.addText=function(t){var e={};return o(e,t),s.add(e)},s.add=function(n){var i=a(n);return t.replaceSpacesWithDashes&&(i=i.replace(/\s/g,"-")),o(n,i),r(n)?(s.items.push(n),e.trigger("tag-added",{$tag:n})):i&&e.trigger("invalid-tag",{$tag:n}),n},s.remove=function(t){var n=s.items.splice(t,1)[0];return e.trigger("tag-removed",{$tag:n}),n},s.removeLast=function(){var e,n=s.items.length-1;return t.enableEditingLastTag||s.selected?(s.selected=null,e=s.remove(n)):s.selected||(s.selected=s.items[n]),e},s}function g(t){return-1!==u.indexOf(t)}return{restrict:"E",require:"ngModel",scope:{tags:"=ngModel",onTagAdded:"&",onTagRemoved:"&"},replace:!1,transclude:!0,templateUrl:"ngTagsInput/tags-input.html",controller:["$scope","$attrs","$element",function(e,n,a){e.events=new t,l.load("tagsInput",e,n,{type:[String,"text",g],placeholder:[String,"Add a tag"],tabindex:[Number,null],removeTagSymbol:[String,String.fromCharCode(215)],replaceSpacesWithDashes:[Boolean,!0],minLength:[Number,3],maxLength:[Number,s],addOnEnter:[Boolean,!0],addOnSpace:[Boolean,!1],addOnComma:[Boolean,!0],addOnBlur:[Boolean,!0],allowedTagsPattern:[RegExp,/.+/],enableEditingLastTag:[Boolean,!1],minTags:[Number,0],maxTags:[Number,s],displayProperty:[String,"text"],allowLeftoverText:[Boolean,!1],addFromAutocompleteOnly:[Boolean,!1]}),e.tagList=new c(e.options,e.events),this.registerAutocomplete=function(){var t=a.find("input");return t.on("keydown",function(t){e.events.trigger("input-keydown",t)}),{addTag:function(t){return e.tagList.add(t)},focusInput:function(){t[0].focus()},getTags:function(){return e.tags},getCurrentTagText:function(){return e.newTag.text},getOptions:function(){return e.options},on:function(t,n){return e.events.on(t,n),this}}}}],link:function(t,n,s,u){var l,c=[r.enter,r.comma,r.space,r.backspace],g=t.tagList,d=t.events,p=t.options,f=n.find("input"),m=["minTags","maxTags","allowLeftoverText"];l=function(){u.$setValidity("maxTags",t.tags.length<=p.maxTags),u.$setValidity("minTags",t.tags.length>=p.minTags),u.$setValidity("leftoverText",p.allowLeftoverText?!0:!t.newTag.text)},d.on("tag-added",t.onTagAdded).on("tag-removed",t.onTagRemoved).on("tag-added",function(){t.newTag.text=""}).on("tag-added tag-removed",function(){u.$setViewValue(t.tags)}).on("invalid-tag",function(){t.newTag.invalid=!0}).on("input-change",function(){g.selected=null,t.newTag.invalid=null}).on("input-focus",function(){u.$setValidity("leftoverText",!0)}).on("input-blur",function(){p.addFromAutocompleteOnly||(p.addOnBlur&&g.addText(t.newTag.text),l())}).on("option-change",function(t){-1!==m.indexOf(t.name)&&l()}),t.newTag={text:"",invalid:null},t.getDisplayText=function(t){return i(t[p.displayProperty])},t.track=function(t){return t[p.displayProperty]},t.newTagChange=function(){d.trigger("input-change",t.newTag.text)},t.$watch("tags",function(n){t.tags=e(n,p.displayProperty),g.items=t.tags}),t.$watch("tags.length",function(){l()}),f.on("keydown",function(e){if(!e.isImmediatePropagationStopped||!e.isImmediatePropagationStopped()){var n,a,i=e.keyCode,o=e.shiftKey||e.altKey||e.ctrlKey||e.metaKey,s={};if(!o&&-1!==c.indexOf(i))if(s[r.enter]=p.addOnEnter,s[r.comma]=p.addOnComma,s[r.space]=p.addOnSpace,n=!p.addFromAutocompleteOnly&&s[i],a=!n&&i===r.backspace&&0===t.newTag.text.length,n)g.addText(t.newTag.text),t.$apply(),e.preventDefault();else if(a){var u=g.removeLast();u&&p.enableEditingLastTag&&(t.newTag.text=u[p.displayProperty]),t.$apply(),e.preventDefault()}}}).on("focus",function(){t.hasFocus||(t.hasFocus=!0,d.trigger("input-focus"),t.$apply())}).on("blur",function(){a(function(){var e=o.prop("activeElement"),a=e===f[0],i=n[0].contains(e);(a||!i)&&(t.hasFocus=!1,d.trigger("input-blur"))})}),n.find("div").on("click",function(){f[0].focus()})}}}]),l.directive("autoComplete",["$document","$timeout","$sce","tagsInputConfig",function(t,s,u,l){function c(t,a){var i,o,r,u={};return o=function(t,e){return t.filter(function(t){return!n(e,t,a.tagsInput.displayProperty)})},u.reset=function(){r=null,u.items=[],u.visible=!1,u.index=-1,u.selected=null,u.query=null,s.cancel(i)},u.show=function(){u.selected=null,u.visible=!0},u.load=function(n,l){s.cancel(i),i=s(function(){u.query=n;var i=t({$query:n});r=i,i.then(function(t){i===r&&(t=e(t.data||t,a.tagsInput.displayProperty),t=o(t,l),u.items=t.slice(0,a.maxResultsToShow),u.items.length>0?u.show():u.reset())})},a.debounceDelay,!1)},u.selectNext=function(){u.select(++u.index)},u.selectPrior=function(){u.select(--u.index)},u.select=function(t){0>t?t=u.items.length-1:t>=u.items.length&&(t=0),u.index=t,u.selected=u.items[t]},u.reset(),u}return{restrict:"E",require:"^tagsInput",scope:{source:"&"},templateUrl:"ngTagsInput/auto-complete.html",link:function(t,e,n,s){var g,d,p,f,m,h,v=[r.enter,r.tab,r.escape,r.up,r.down];l.load("autoComplete",t,n,{debounceDelay:[Number,100],minLength:[Number,3],highlightMatchedText:[Boolean,!0],maxResultsToShow:[Number,10],loadOnDownArrow:[Boolean,!1],loadOnEmpty:[Boolean,!1],loadOnFocus:[Boolean,!1]}),p=t.options,d=s.registerAutocomplete(),p.tagsInput=d.getOptions(),g=new c(t.source,p),f=function(t){return t[p.tagsInput.displayProperty]},m=function(t){return i(f(t))},h=function(t){return t&&t.length>=p.minLength||!t&&p.loadOnEmpty},t.suggestionList=g,t.addSuggestionByIndex=function(e){g.select(e),t.addSuggestion()},t.addSuggestion=function(){var t=!1;return g.selected&&(d.addTag(g.selected),g.reset(),d.focusInput(),t=!0),t},t.highlight=function(t){var e=m(t);return e=o(e),p.highlightMatchedText&&(e=a(e,o(g.query),"<em>$&</em>")),u.trustAsHtml(e)},t.track=function(t){return f(t)},d.on("tag-added tag-removed invalid-tag input-blur",function(){g.reset()}).on("input-change",function(t){h(t)?g.load(t,d.getTags()):g.reset()}).on("input-focus",function(){var t=d.getCurrentTagText();p.loadOnFocus&&h(t)&&g.load(t,d.getTags())}).on("input-keydown",function(e){var n=!1;e.stopImmediatePropagation=function(){n=!0,e.stopPropagation()},e.isImmediatePropagationStopped=function(){return n};var a=e.keyCode,i=!1;-1!==v.indexOf(a)&&(g.visible?a===r.down?(g.selectNext(),i=!0):a===r.up?(g.selectPrior(),i=!0):a===r.escape?(g.reset(),i=!0):(a===r.enter||a===r.tab)&&(i=t.addSuggestion()):a===r.down&&t.options.loadOnDownArrow&&(g.load(d.getCurrentTagText(),d.getTags()),i=!0),i&&(e.preventDefault(),e.stopImmediatePropagation(),t.$apply()))})}}}]),l.directive("tiTranscludeAppend",function(){return function(t,e,n,a,i){i(function(t){e.append(t)})}}),l.directive("tiAutosize",["tagsInputConfig",function(t){return{restrict:"A",require:"ngModel",link:function(e,n,a,i){var o,r,s=t.getTextAutosizeThreshold();o=angular.element('<span class="input"></span>'),o.css("display","none").css("visibility","hidden").css("width","auto").css("white-space","pre"),n.parent().append(o),r=function(t){var e,i=t;return angular.isString(i)&&0===i.length&&(i=a.placeholder),i&&(o.text(i),o.css("display",""),e=o.prop("offsetWidth"),o.css("display","none")),n.css("width",e?e+s+"px":""),t},i.$parsers.unshift(r),i.$formatters.unshift(r),a.$observe("placeholder",function(t){i.$modelValue||r(t)})}}}]),l.directive("tiBindAttrs",function(){return function(t,e,n){t.$watch(n.tiBindAttrs,function(t){angular.forEach(t,function(t,e){n.$set(e,t)})},!0)}}),l.provider("tagsInputConfig",function(){var t={},e={},n=3;this.setDefaults=function(e,n){return t[e]=n,this},this.setActiveInterpolation=function(t,n){return e[t]=n,this},this.setTextAutosizeThreshold=function(t){return n=t,this},this.$get=["$interpolate",function(a){var i={};return i[String]=function(t){return t},i[Number]=function(t){return parseInt(t,10)},i[Boolean]=function(t){return"true"===t.toLowerCase()},i[RegExp]=function(t){return new RegExp(t)},{load:function(n,o,r,s){var u=function(){return!0};o.options={},angular.forEach(s,function(s,l){var c,g,d,p,f,m;c=s[0],g=s[1],d=s[2]||u,p=i[c],f=function(){var e=t[n]&&t[n][l];return angular.isDefined(e)?e:g},m=function(t){o.options[l]=t&&d(t)?p(t):f()},e[n]&&e[n][l]?r.$observe(l,function(t){m(t),o.events.trigger("option-change",{name:l,newValue:t})}):m(r[l]&&a(r[l])(o.$parent))})},getTextAutosizeThreshold:function(){return n}}}]}),l.run(["$templateCache",function(t){t.put("ngTagsInput/tags-input.html",'<div class="host" tabindex="-1" ti-transclude-append=""><div class="tags" ng-class="{focused: hasFocus}"><ul class="tag-list"><li class="tag-item" ng-repeat="tag in tagList.items track by track(tag)" ng-class="{ selected: tag == tagList.selected }"><span ng-bind="getDisplayText(tag)"></span> <a class="remove-button" ng-click="tagList.remove($index)" ng-bind="options.removeTagSymbol"></a></li></ul><input class="input" ng-model="newTag.text" ng-change="newTagChange()" ng-trim="false" ng-class="{\'invalid-tag\': newTag.invalid}" ti-bind-attrs="{type: options.type, placeholder: options.placeholder, tabindex: options.tabindex}" ti-autosize=""></div></div>'),t.put("ngTagsInput/auto-complete.html",'<div class="autocomplete" ng-show="suggestionList.visible"><ul class="suggestion-list"><li class="suggestion-item" ng-repeat="item in suggestionList.items track by track(item)" ng-class="{selected: item == suggestionList.selected}" ng-click="addSuggestionByIndex($index)" ng-mouseenter="suggestionList.select($index)" ng-bind-html="highlight(item)"></li></ul></div>')}])}();
...
!function (e, t) {
	...
	var r = t.isDefined, n = t.isUndefined, i = t.isNumber, a = t.isObject, c = t.isArray, s = t.extend, u = t.toJson, l = t.fromJson, g = t.module("LocalStorageModule", []);
	g.provider("localStorageService", function () {
		this.prefix = "ls", this.storageType = "localStorage", this.cookie = {
			expiry: 30,
			path: "/"
		}, this.notify = {setItem: !0, removeItem: !1}, this.setPrefix = function (e) {
			this.prefix = e
		}, this.setStorageType = function (e) {
			this.storageType = e
		}, this.setStorageCookie = function (e, t) {
			this.cookie = {expiry: e, path: t}
		}, this.setStorageCookieDomain = function (e) {
			this.cookie.domain = e
		}, this.setNotify = function (e, t) {
			this.notify = {setItem: e, removeItem: t}
		}, this.$get = ["$rootScope", "$window", "$document", "$parse", function (e, t, g, f) {
			var d, m = this, h = m.prefix, S = m.cookie, p = m.notify, T = m.storageType;
			g ? g[0] && (g = g[0]) : g = document, "." !== h.substr(-1) && (h = h ? h + "." : "");
			var y = function (e) {
				return h + e
			}, v = function () {
				try {
					var o = T in t && null !== t[T], r = y("__" + Math.round(1e7 * Math.random()));
					return o && (d = t[T], d.setItem(r, ""), d.removeItem(r)), o
				} catch (n) {
					return T = "cookie", e.$broadcast("LocalStorageModule.notification.error", n.message), !1
				}
			}(), O = function (t, o) {
				if (n(o) ? o = null : (a(o) || c(o) || i(+o || o)) && (o = u(o)), !v || "cookie" === m.storageType)return v || e.$broadcast("LocalStorageModule.notification.warning", "LOCAL_STORAGE_NOT_SUPPORTED"), p.setItem && e.$broadcast("LocalStorageModule.notification.setitem", {
					key: t,
					newvalue: o,
					storageType: "cookie"
				}), _(t, o);
				try {
					(a(o) || c(o)) && (o = u(o)), d && d.setItem(y(t), o), p.setItem && e.$broadcast("LocalStorageModule.notification.setitem", {
						key: t,
						newvalue: o,
						storageType: m.storageType
					})
				} catch (r) {
					return e.$broadcast("LocalStorageModule.notification.error", r.message), _(t, o)
				}
				return !0
			}, b = function (t) {
				if (!v || "cookie" === m.storageType)return v || e.$broadcast("LocalStorageModule.notification.warning", "LOCAL_STORAGE_NOT_SUPPORTED"), A(t);
				var r = d ? d.getItem(y(t)) : null;
				return r && "null" !== r ? "{" === r.charAt(0) || "[" === r.charAt(0) || o(r) ? l(r) : r : null
			}, k = function (t) {
				if (!v || "cookie" === m.storageType)return v || e.$broadcast("LocalStorageModule.notification.warning", "LOCAL_STORAGE_NOT_SUPPORTED"), p.removeItem && e.$broadcast("LocalStorageModule.notification.removeitem", {
					key: t,
					storageType: "cookie"
				}), I(t);
				try {
					d.removeItem(y(t)), p.removeItem && e.$broadcast("LocalStorageModule.notification.removeitem", {
						key: t,
						storageType: m.storageType
					})
				} catch (o) {
					return e.$broadcast("LocalStorageModule.notification.error", o.message), I(t)
				}
				return !0
			}, L = function () {
				if (!v)return e.$broadcast("LocalStorageModule.notification.warning", "LOCAL_STORAGE_NOT_SUPPORTED"), !1;
				var t = h.length, o = [];
				for (var r in d)if (r.substr(0, t) === h)try {
					o.push(r.substr(t))
				} catch (n) {
					return e.$broadcast("LocalStorageModule.notification.error", n.Description), []
				}
				return o
			}, $ = function (t) {
				t = t || "";
				var o = h.slice(0, -1), r = new RegExp(o + "." + t);
				if (!v || "cookie" === m.storageType)return v || e.$broadcast("LocalStorageModule.notification.warning", "LOCAL_STORAGE_NOT_SUPPORTED"), w();
				var n = h.length;
				for (var i in d)if (r.test(i))try {
					k(i.substr(n))
				} catch (a) {
					return e.$broadcast("LocalStorageModule.notification.error", a.message), w()
				}
				return !0
			}, M = function () {
				try {
					return navigator.cookieEnabled || "cookie"in g && (g.cookie.length > 0 || (g.cookie = "test").indexOf.call(g.cookie, "test") > -1)
				} catch (t) {
					return e.$broadcast("LocalStorageModule.notification.error", t.message), !1
				}
			}, _ = function (t, o) {
				if (n(o))return !1;
				if ((c(o) || a(o)) && (o = u(o)), !M())return e.$broadcast("LocalStorageModule.notification.error", "COOKIES_NOT_SUPPORTED"), !1;
				try {
					var r = "", i = new Date, s = "";
					if (null === o ? (i.setTime(i.getTime() + -864e5), r = "; expires=" + i.toGMTString(), o = "") : 0 !== S.expiry && (i.setTime(i.getTime() + 24 * S.expiry * 60 * 60 * 1e3), r = "; expires=" + i.toGMTString()), t) {
						var l = "; path=" + S.path;
						S.domain && (s = "; domain=" + S.domain), g.cookie = y(t) + "=" + encodeURIComponent(o) + r + l + s
					}
				} catch (f) {
					return e.$broadcast("LocalStorageModule.notification.error", f.message), !1
				}
				return !0
			}, A = function (t) {
				if (!M())return e.$broadcast("LocalStorageModule.notification.error", "COOKIES_NOT_SUPPORTED"), !1;
				for (var o = g.cookie && g.cookie.split(";") || [], r = 0; r < o.length; r++) {
					for (var n = o[r]; " " === n.charAt(0);)n = n.substring(1, n.length);
					if (0 === n.indexOf(y(t) + "=")) {
						var i = decodeURIComponent(n.substring(h.length + t.length + 1, n.length));
						try {
							var a = JSON.parse(i);
							return l(a)
						} catch (c) {
				...
				for (var e = null, t = h.length, o = g.cookie.split(";"), r = 0; r < o.length; r++) {
					for (e = o[r]; " " === e.charAt(0);)e = e.substring(1, e.length);
					var n = e.substring(t, e.indexOf("="));
					I(n)
				}
			}, x = function () {
				return T
				...
				n = n || t;
				var i = b(n);
				return null === i && r(o) ? i = o : a(i) && a(o) && (i = s(o, i)), f(t).assign(e, i), e.$watch(t, function (e) {
					O(n, e)
				}, a(e[t]))
			}, P = function () {
				for (var e = 0, o = t[T], r = 0; r < o.length; r++)0 === o.key(r).indexOf(h) && e++;
				return e
			};
			return {
				isSupported: v,
				...
				deriveKey: y,
				length: P,
				cookie: {set: _, add: _, get: A, remove: I, clearAll: w}
			}
		}]
	})
